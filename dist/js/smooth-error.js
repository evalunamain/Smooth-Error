;(function ($, window, document) {
  ...
  $.extend(SmoothError.prototype, {
    ...
    initErrorElement: function () {
      ...
      stateWrapper.prepend($('<span class="se-svalidation-icon se-field-valid">')).prepend($('<span class="se-validation-icon se-field-invalid">')).prepend($('<span class="se-error-tooltip">'));
